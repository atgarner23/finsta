...
/**
 * creates the follow interface on the profile page
 * @param $profile_id INT takes the user_id of the profile you are viewing
 */
...
?>
    ...
    <?php if ($logged_in_user and $logged_in_user['user_id'] != $profile_id) { ?>
        <div class="item"><button class="follow-button <?php echo $class; ?>" data-to="<?php echo $profile_id; ?>"><?php echo $label; ?></button></div>
<?php
    } //end if
}
